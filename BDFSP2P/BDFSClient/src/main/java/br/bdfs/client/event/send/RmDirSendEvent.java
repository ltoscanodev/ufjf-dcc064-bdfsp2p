 ...
 * @author ltosc
 */
public class RmDirSendEvent extends DfsSendEvent
{
    ...
    public RmDirSendEvent(String token, String path) 
    {
        this.token = token;
        this.path = path;
    }
    ...
    {
        DfsLogger.logDebug("RmDirEvent.sendEvent()");
        
        HashMap<String, String> paramList = new HashMap<>();
        paramList.put("TOKEN", token);
        paramList.put("DIR_PATH", path);
